export const expedicao = {
  ...
  cidades: ['Manaus', 'Presidente Figueiredo', 'Rio Negro', 'Encontro das Águas'],
  cidadesPrincipaisLinha: 'Manaus · Presidente Figueiredo · Rio Negro',
  bandeira: '🇧🇷',
  ...
  mapaTrajetoTexto: 'Manaus → Presidente Figueiredo → Rio Negro → Encontro das Águas',
  ...
  faixaInvestimento: { min: 6988, max: 11988 },
...
export const roteiro = [
  ...
  },
  {
    dia: 2,
    data: '08/07',
    cidade: 'Manaus/Presidente Figueiredo',
    titulo: 'Teatro Amazonas & Presidente Figueiredo',
    atividades: [
      'Visita ao Teatro Amazonas',
      'Transfer até Presidente Figueiredo',
      'Trilha guiada, cachoeiras e piscinas naturais',
      'Retorno a Manaus',
    ],
  ...
  },
  {
    ...
    data: '09/07',
    cidade: 'Rio Negro',
    titulo: 'Passeio pelo Rio Negro',
    atividades: [
      'Navegação pelo Rio Negro até o Encontro das Águas',
    ...
    destaque: true,
    veiculos: [{ emoji: '🚤', label: 'Navegação pelo Rio Negro' }],
  },
  {
    dia: 4,
    data: '10/07',
    cidade: 'Rio Negro',
    titulo: 'Churrasco no Flutuante',
    atividades: [
      'Embarque em barco privativo',
      'Churrasco no flutuante com banda ao vivo',
      'Drinks e música nas águas escuras',
      'Pôr do sol no rio na última noite',
    ],
