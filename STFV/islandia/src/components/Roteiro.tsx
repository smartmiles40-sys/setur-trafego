...
export default function Roteiro() {
  return (
    ...
    >
      ...
      {/* Carrossel do roteiro dia a dia */}
            ...
            <SwiperSlide key={dia.dia}>
              ...
              >
                ...
                <div className="relative h-[360px] md:h-[440px] overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-off-white/95 backdrop-blur-sm text-dark-teal rounded-full px-3 py-1.5 md:px-3 md:py-1.5 shadow flex items-center gap-2 z-10">
                    <span className="text-[11px] md:text-[10px] font-bold tracking-[0.18em] md:tracking-[0.2em] uppercase">
                      Dia {dia.dia}
                    </span>
                    <span className="w-1 h-1 rounded-full bg-dark-teal/40" />
                    <span className="text-[13px] md:text-xs font-semibold tabular-nums">{dia.data}</span>
                  </div>
