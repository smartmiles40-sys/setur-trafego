export const expedicao = {
  ...
  cidades: ['Reykjavík', 'Sul', 'Leste', 'Norte', 'Sudoeste'],
  ...
  mapaDescricao:
    'Uma volta completa ao redor da Islândia: das cachoeiras do sul a Jökulsárlón, dos chifres do leste a Mývatn no norte, finalizando no Golden Circle e no termal Blue Lagoon — em veículos 4×4 modificados, com caça à aurora boreal todas as noites.',
  mapaTrajetoTexto: 'Reykjavík → Sul → Leste → Norte → Golden Circle → Blue Lagoon',
  ...
  roteiroDescricao:
    'Este não é um roteiro para "ver tudo correndo". É uma sequência de experiências que atravessam a Islândia — das cachoeiras do sul aos fiordes do leste, do norte vulcânico ao Golden Circle e ao Blue Lagoon — respeitando ritmo, pausas e acompanhamento constante.',
  ...
  vsl: {
    playerId: 'vid-6a3e9b33e172d6fc8663e6bd',
    playerSrc:
      'https://scripts.converteai.net/f972c0cf-928d-4614-95cd-e71e2faac7be/players/6a3e9b33e172d6fc8663e6bd/v4/player.js',
  },
...
export const roteiro = [
  ...
  },
  {
    ...
    data: '15/02',
    cidade: 'Sul',
    titulo: 'Cachoeiras do Sul & Areia Preta',
    atividades: [
      'Seljalandsfoss — caminhe por trás da queda',
      'Gljúfrabúi — cachoeira escondida na gruta',
      'Skógafoss — o ícone da costa sul',
      'Reynisfjara, praia de areia preta · aurora',
    ],
    logistica: '4×4 modificado + guia brasileiro · aurora hunt',
    imagem: `${import.meta.env.BASE_URL}assets/islandia/cachoeira.jpg`,
    destaque: true,
  ...
  },
  {
    ...
    atividades: [
      'Lagoa glaciar Jökulsárlón repleta de icebergs',
      'Diamond Beach — gelo lapidado na areia preta',
      'Ice Cave — o azul infinito dentro da geleira',
  ...
  },
  {
    ...
    data: '17/02',
    cidade: 'Leste',
    titulo: 'Chifres do Leste & Travessia',
    atividades: [
      'Vestrahorn — montanhas à beira-mar',
      'Possibilidade de andar sobre lago congelado',
      'Travessia do leste com paradas fotográficas',
  ...
  },
  {
    ...
    data: '18/02',
    cidade: 'Norte',
    titulo: 'Cachoeiras do Norte & Geotermia',
    atividades: [
      'Goðafoss — a cachoeira dos deuses',
      'Cânion Stuðagil — basalto e rio esmeralda',
      'Perpetual Shower — chuveiro geotérmico de Krafla',
      'Hverir: fumarolas e lama borbulhante · aurora',
    ],
  ...
  },
  {
    ...
    data: '19/02',
    cidade: 'Norte',
    titulo: 'Desfiladeiro, Hverfjall & Mar Ártico',
    atividades: [
      'Desfiladeiro rochoso com paredes de 100 m',
      'Subida ao vulcão Hverfjall e lago Mývatn',
      'Piscina aquecida + mergulho no Mar Ártico',
  ...
  },
  {
    ...
    atividades: [
      'Friðheimar — estufa de tomates com almoço especial',
      'Gullfoss — a cachoeira dourada',
      'Geysir — jatos de +20 m do Strokkur',
      'Caça à aurora à noite',
    ],
    logistica: '4×4 modificado + guia brasileiro · aurora hunt',
  ...
  },
  {
    dia: 9,
    data: '21/02',
    cidade: 'Þingvellir/Grindavík',
    titulo: 'Þingvellir & Blue Lagoon',
    atividades: [
      'Þingvellir — entre as placas tectônicas',
      'Experiência termal no Blue Lagoon (~39 °C)',
...
export const whatsappUrl = `https://wa.me/message/LCFMFUISIWL5G1`
