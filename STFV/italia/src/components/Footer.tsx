  ...
  return (
    <footer className="bg-dark-teal text-off-white relative overflow-hidden grain-subtle">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
        {/* "COSTA AMALFITANA" tem 16 caracteres: acima de ~9vw o nome quebra
            em duas linhas. O nowrap + clamp garante UMA linha em qualquer tela. */}
        <span
          className="num-stamp text-off-white/5 whitespace-nowrap"
          style={{ fontSize: 'clamp(2rem, 9vw, 9rem)', lineHeight: '1' }}
        >
          {expedicao.nomeUpper}
        </span>
      </div>
