export const expedicao = {
  ...
  duracao: '9 dias',
  duracaoNumero: 9,
  duracaoNumeroLegenda: '8 noites entre Cusco, Águas Calientes, Ica e Lima, com ritmo pensado para a altitude.',
  duracaoExtenso: '9 dias · 8 noites',
  saida: 'Aeroporto de Guarulhos (GRU)',
  saidaCurta: 'Saída de Guarulhos (GRU)',
  cidades: ['Cusco', 'Vale Sagrado', 'Machu Picchu', 'Vinicunca', 'Lima', 'Huacachina'],
  ...
  mapaDescricao:
    'Uma travessia que conecta os Andes à costa do Pacífico — de Cusco ao Vale Sagrado, Machu Picchu e Montanha Colorida, descendo para Lima, Ilhas Ballestas e Huacachina, com deslocamentos e acessos resolvidos.',
  mapaTrajetoTexto: 'Cusco → Vale Sagrado → Machu Picchu → Vinicunca → Lima → Huacachina',
  ...
  opcoesDescricao:
    'Uma travessia pelo Peru essencial: Cusco, Vale Sagrado, Machu Picchu, Montanha Colorida, Lima, Paracas e Huacachina — com acompanhamento constante e experiências conduzidas.',
...
export const roteiro = [
  {
    ...
    atividades: ['Chegada ao aeroporto de Cusco', 'Traslado ao hotel', 'Aclimatação à altitude com ritmo leve'],
  ...
  },
  {
    ...
    atividades: ['Chinchero e mercado local', 'Vale Sagrado dos Incas', 'Trem Expedition — pernoite em Águas Calientes'],
    logistica: 'Transfer privativo + guia + trem Expedition',
  ...
  },
  {
    ...
    cidade: 'Machu Picchu',
    titulo: 'Machu Picchu',
    atividades: ['Tour guiado em Machu Picchu', 'Uma das 7 maravilhas do mundo moderno', 'Retorno a Cusco no trem Expedition'],
    logistica: 'Trem Expedition + guia especializado',
    imagem: `${import.meta.env.BASE_URL}assets/peru/machu-picchu.jpg`,
    destaque: true,
    veiculos: [{ emoji: '🚆', label: 'Trem Expedition' }],
  },
  {
    dia: 4,
    data: '25/08',
  ...
  },
  {
    ...
    atividades: ['Trilha à Montanha Colorida — subida de mototáxi', 'Paisagens únicas dos Andes', 'Retorno a Cusco'],
    logistica: 'Transfer + mototáxi + guia + alimentação',
    imagem: `${import.meta.env.BASE_URL}assets/peru/vinicunca.jpg`,
    destaque: true,
    veiculos: [
      { emoji: '🚙', label: 'Transfer 4×4' },
      { emoji: '🛺', label: 'Mototáxi na trilha' },
    ],
  },
  {
    dia: 6,
    ...
    atividades: ['Voo Cusco → Lima', 'Traslado ao hotel', 'Tarde livre em Miraflores'],
    logistica: 'Voo doméstico + transfer',
  ...
  },
  {
    ...
    atividades: ['Passeio de barco Ilhas Ballestas', 'Oásis de Huacachina', 'Buggy nas dunas + sandboarding', 'Pernoite em Ica'],
  ...
  },
  {
    ...
    atividades: ['Saída de Ica', 'Retorno a Lima', 'Tarde livre — Centro Histórico, Miraflores e Barranco', 'Última noite em Lima'],
    logistica: 'Transfer terrestre Ica → Lima',
    imagem: `${import.meta.env.BASE_URL}assets/peru/lima-chegada.jpg`,
    destaque: false,
