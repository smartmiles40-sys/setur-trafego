  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        {/* Nesta LP o roteiro é a última seção antes do rodapé: quem chegou até
            aqui precisa de um caminho de volta para a inscrição (que fica logo
            acima, depois dos depoimentos) — senão teria que rolar atrás dela. */}
        <motion.div
