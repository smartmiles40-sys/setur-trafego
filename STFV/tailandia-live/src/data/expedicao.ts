/**
 * Dados de marca reaproveitados da LP da Expedição Japão (STFV/japao-china).
 *
 * Esta LP é uma isca de live: só precisa dos DEPOIMENTOS (prova social), do
 * ROTEIRO (o que a live vai apresentar) e de alguns rótulos da expedição para
 * o rodapé. Tudo que é da live mora em ./live.ts.
 *
...
export const expedicao = {
  ...
  roteiroHeadlineDestino: 'o Japão',
