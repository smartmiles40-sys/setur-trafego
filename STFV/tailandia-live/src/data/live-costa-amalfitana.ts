/**
 * ============================================================================
  *  CONFIGURAÇÃO DA ISCA — LIVE DA EXPEDIÇÃO COSTA AMALFITANA
 * ============================================================================
 *
 *  Mora no MESMO projeto das outras lives e é servida em
 *  https://live.setuforeuvouviagens.com.br/costa-amalfitana.
 ...
 *  daqui é o roteiro, em `roteiro-costa-amalfitana.ts`.
 *
...
export const liveCostaAmalfitana: ConfigLive = {
  ...
  // veio da live).
  fonte: '[Costa Amalfitana] - Live',
  sourceId: 'LIVE_ITALIA', // PREENCHER/CONFERIR no Bitrix
  ...
  expedicao: {
    ...
    resumoExpedicao: '11 dias · 4 a 14 de setembro de 2027',
    saidaCurta: 'Encontro em Guarulhos (GRU)',
  },

  // ---- Copy da primeira tela ----------------------------------------------
  promessa:
    'Uma hora e meia ao vivo com quem organiza a expedição: os 11 dias entre Nápoles, Pompeia, Sorrento, a Costa Amalfitana, Capri e Roma, o que está incluso, quanto custa e as suas perguntas respondidas na hora.',

  topicos: [
    'Roteiro dia a dia',
    'Capri e a costa vista do mar',
  ...
  // ---- A live --------------------------------------------------------------
  evento: {
    titulo: 'Live: Expedição Costa Amalfitana 2027 · Se Tu For, Eu Vou',
    ...
    descricao:
      'Encontro ao vivo com a equipe da Se Tu For, Eu Vou para apresentar a Expedição Costa Amalfitana 2027: os 11 dias entre Nápoles, Pompeia, Sorrento, os vilarejos da costa, Capri e Roma, valores, como funciona o acompanhamento da agência e as vagas disponíveis. Traga suas perguntas.',
  },

  // Mesmo Short das outras lives: o depoimento é sobre a AGÊNCIA, não sobre o
  // destino. Se surgir um de quem foi para Costa Amalfitana, troque.
  depoimentoVideo: {
