/**
 * ============================================================================
  *  CONFIGURAÇÃO DA ISCA — LIVE DA EXPEDIÇÃO EGITO
 * ============================================================================
 *
 *  Mora no MESMO projeto das outras lives e é servida em
 *  https://live.setuforeuvouviagens.com.br/egito.
 ...
 *  daqui é o roteiro, em `roteiro-egito.ts`.
 *
...
export const liveEgito: ConfigLive = {
  ...
  // veio da live).
  fonte: '[Egito] - Live',
  sourceId: 'LIVE_EGITO', // PREENCHER/CONFERIR no Bitrix
  ...
  expedicao: {
    ...
    complementoNome: 'com extensão Dubai',
    ano: 2027,
    // Aparece no rodapé. É a ÚNICA data de turma da página: o carrossel do
    // roteiro mostra "Dia 1, Dia 2...", sem dia do mês.
    resumoExpedicao: '14 dias · 16 a 29 de setembro de 2027',
    saidaCurta: 'Encontro em Guarulhos (GRU)',
  },

  // ---- Copy da primeira tela ----------------------------------------------
  promessa:
    'Uma hora e meia ao vivo com quem organiza a expedição: os 14 dias entre Cairo, o cruzeiro pelo Nilo, Luxor, Hurghada e a extensão Dubai, o que está incluso, quanto custa e as suas perguntas respondidas na hora.',

  topicos: [
    'Roteiro dia a dia',
    'Cruzeiro pelo Nilo e extensão Dubai',
  ...
  // ---- A live --------------------------------------------------------------
  evento: {
    titulo: 'Live: Expedição Egito 2027 · Se Tu For, Eu Vou',
    ...
    descricao:
      'Encontro ao vivo com a equipe da Se Tu For, Eu Vou para apresentar a Expedição Egito 2027: os 14 dias entre Cairo, o cruzeiro pelo Nilo, Luxor, Hurghada e a extensão Dubai, valores, como funciona o acompanhamento da agência e as vagas disponíveis. Traga suas perguntas.',
  },

  // Mesmo Short das outras lives: o depoimento é sobre a AGÊNCIA, não sobre o
  // destino. Se surgir um de quem foi para Egito, troque.
  depoimentoVideo: {
  ...
  heroImage: `${import.meta.env.BASE_URL}assets/egito/hero-piramides.webp`,
