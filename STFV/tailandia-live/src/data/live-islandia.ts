/**
 * ============================================================================
  *  CONFIGURAÇÃO DA ISCA — LIVE DA EXPEDIÇÃO ISLÂNDIA
 * ============================================================================
 *
 *  Mora no MESMO projeto das outras lives e é servida em
 *  https://live.setuforeuvouviagens.com.br/islandia.
 ...
 *  daqui é o roteiro, em `roteiro-islandia.ts`.
 *
...
export const liveIslandia: ConfigLive = {
  ...
  // veio da live).
  fonte: '[Islândia] - Live',
  sourceId: 'LIVE_ISLANDIA', // PREENCHER/CONFERIR no Bitrix
  ...
  expedicao: {
    ...
    resumoExpedicao: '11 dias · 13 a 23 de fevereiro de 2027',
    saidaCurta: 'Encontro em Guarulhos (GRU)',
  },

  // ---- Copy da primeira tela ----------------------------------------------
  promessa:
    'Uma hora e meia ao vivo com quem organiza a expedição: os 11 dias pela Islândia — Círculo Dourado, praias negras, Jökulsárlón e as noites de caça à aurora —, o que está incluso, quanto custa e as suas perguntas respondidas na hora.',

  topicos: [
    'Roteiro dia a dia',
    'Aurora boreal: como funciona a caça',
  ...
  // ---- A live --------------------------------------------------------------
  evento: {
    titulo: 'Live: Expedição Islândia 2027 · Se Tu For, Eu Vou',
    ...
    descricao:
      'Encontro ao vivo com a equipe da Se Tu For, Eu Vou para apresentar a Expedição Islândia 2027: os 11 dias pelo Círculo Dourado, praias negras, a lagoa Jökulsárlón e as noites de aurora boreal, valores, como funciona o acompanhamento da agência e as vagas disponíveis. Traga suas perguntas.',
  },

  // Mesmo Short das outras lives: o depoimento é sobre a AGÊNCIA, não sobre o
  // destino. Se surgir um de quem foi para Islândia, troque.
  depoimentoVideo: {
