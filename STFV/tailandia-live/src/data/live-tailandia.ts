 ...
 *  https://live.setuforeuvouviagens.com.br/tailandia.
 ...
 *  daqui é o roteiro, em `roteiro-tailandia.ts`.
 *
...
export const liveTailandia: ConfigLive = {
  ...
  // veio da live).
  fonte: '[Tailândia] - Live',
  sourceId: 'LIVE_TAILANDIA', // PREENCHER/CONFERIR no Bitrix
  ...
  expedicao: {
    ...
    resumoExpedicao: '6 a 21 de novembro de 2027 · Bangkok, Chiang Mai e Phi Phi',
    saidaCurta: 'Encontro em Guarulhos (GRU)',
  },

  // ---- Copy da primeira tela ----------------------------------------------
  promessa:
    'Uma hora e meia ao vivo com quem organiza a expedição: o roteiro pela Tailândia — Bangkok, Chiang Mai e as ilhas Phi Phi —, o que está incluso, quanto custa e as suas perguntas respondidas na hora.',

  topicos: [
    'Roteiro dia a dia',
    'Chiang Mai e o santuário de elefantes',
  ...
  evento: {
    ...
    descricao:
      'Encontro ao vivo com a equipe da Se Tu For, Eu Vou para apresentar a Expedição Tailândia 2027: o roteiro por Bangkok, Chiang Mai e as ilhas Phi Phi, valores, como funciona o acompanhamento da agência e as vagas disponíveis. Traga suas perguntas.',
  },

  // Mesmo Short das outras lives: o depoimento é sobre a AGÊNCIA, não sobre o
  // destino. Se surgir um de quem foi para Tailândia, troque.
  depoimentoVideo: {
