...
export const liveTurquia: ConfigLive = {
  ...
  evento: {
     ...
     */
    // 🔁 Remarcada em 21/09/2026 para domingo, 27 de setembro de 2026, 20h00 (sala nova).
    inicioISO: '2026-09-27T20:00:00-03:00',
    duracaoMinutos: 90,
    ...
    meetUrl: 'https://meet.google.com/yis-dunh-opv',
