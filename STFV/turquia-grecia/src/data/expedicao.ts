...
export const roteiro = [
  ...
  },
  {
    ...
    logistica: 'Traslado aeroporto → hotel + acompanhamento',
  ...
  },
  {
    ...
    data: '14/06',
    cidade: 'Istambul',
    titulo: 'Istambul Imperial & Bósforo',
    atividades: [
      'Hipódromo, Mesquita Azul e Santa Sofia',
      'Cisterna da Basílica',
      'Grande Bazar e Palácio de Topkapı',
      'Passeio de barco pelo Estreito de Bósforo',
    ],
    logistica: 'Guia em português + ingressos + barco no Bósforo',
  ...
  },
  {
    ...
    atividades: [
      ...
      'Primeiro pôr do sol entre as chaminés de fada',
    ],
    logistica: 'Voo doméstico + transfer + hotel-caverna',
  ...
  },
  {
    ...
    atividades: [
      'Voo de balão ao nascer do sol (opcional)',
  ...
  },
  {
    ...
    atividades: [
      'Nova tentativa de voo de balão (opcional)',
      'Cidade Subterrânea de Özkonak',
      'Caminhada no Vale de Ihlara',
      'Mosteiro de Selime e Vale dos Pombos',
    ],
    logistica: 'Guia em português + transporte privativo + balão opcional',
  ...
  },
  {
    dia: 7,
    data: '18/06',
    cidade: 'Capadócia → Pamukkale',
    titulo: 'Terraços de Pamukkale & Cleópatra',
    atividades: [
      'Saída da Capadócia rumo a Pamukkale',
      'Terraços termais de calcário branco',
      'Ruínas de Hierápolis',
      'Banho na Piscina de Cleópatra',
    ],
    logistica: 'Transfer terrestre + ingressos + hotel termal',
  ...
  },
  {
    dia: 8,
    data: '19/06',
    cidade: 'Pamukkale → Kusadasi',
    titulo: 'Embarque no Cruzeiro & Patmos',
    atividades: [
      'Transfer de Pamukkale até Kusadasi',
      'Embarque no cruzeiro pelas ilhas gregas',
      'Pensão completa a bordo',
      'Escala em Patmos — a ilha do Apocalipse',
    ],
    logistica: 'Transfer + embarque cruzeiro + escala Patmos · pensão completa',
    imagem: `${import.meta.env.BASE_URL}assets/turquia-grecia/dia-08.jpg`,
    destaque: true,
    veiculos: [
      { emoji: '🚐', label: 'Transfer → Kusadasi' },
  ...
  },
  {
    ...
    titulo: 'Creta & Pôr do sol em Oia',
    atividades: [
      'Palácio de Knossos, em Creta',
      'Travessia até Santorini',
      'Vilarejos brancos sobre a caldeira',
  ...
  },
  {
    ...
    atividades: [
      'Café da manhã e check-out em Istambul',
