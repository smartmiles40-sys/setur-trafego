...
// Versão STFV (sem vídeo): o formulário fica direto na página, sem o funil VSL
// de 2 páginas. Mesma estrutura visual das LPs com vídeo — só o card final
// (que antes levava pra proxima-etapa.html) virou o <FormularioLead /> inline.
