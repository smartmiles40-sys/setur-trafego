...
// FORMULÁRIO INLINE na página (padrão Itália/Turquia) — esta LP NÃO usa o
// funil VSL de duas páginas; o FormularioLead multi-etapas mora aqui mesmo.
    ...
    >
      ...
      <div className="relative pt-24 md:pt-32 pb-10 md:pb-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-dark-teal/30 mx-1">·</span> Nós cuidamos de tudo
          </motion.p>
        </div>
      </div>
      ...
      <div className="relative container-x max-w-3xl pb-24 md:pb-32 form-section-container">
        ...
        >
          ...
          {/* Formulário próprio multi-etapas (versão de TRÁFEGO: UTMs, lead_id
              e eventos dataLayer pro GTM) */}
          <FormularioLead />
