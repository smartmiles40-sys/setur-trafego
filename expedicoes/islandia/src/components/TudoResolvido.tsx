...
const iconeMap = { Leaf, Mountain, Snowflake, Sun, Palmtree, Compass }
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3 md:gap-4">
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-br from-dark-teal/85 via-dark-teal/55 to-dark-teal/90" />
