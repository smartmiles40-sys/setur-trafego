        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="relative flex items-center justify-center gap-4 md:gap-8 flex-wrap md:flex-nowrap">
            ...
            <div className="relative inline-block">
              ...
              >
                {/* SEMPRE 2 linhas: a 2ª ("Costa Amalfitana 2027", 21 caracteres)
                    usa nowrap + fonte menor — acima de ~6vw ela quebra e o
                    letreiro vira 4 linhas. */}
                <span className="block text-[clamp(3rem,11vw,8.5rem)]">Expedição</span>
                <span className="block whitespace-nowrap text-[clamp(1.75rem,6vw,5.25rem)]">
