...
export const incluso = [
  {
    ...
    desc: 'GRU → Pequim, Pequim → Osaka, Tóquio → GRU',
    emoji: '✈️',
  },
  {
    icon: 'Train',
...
export const faq = [
  ...
  },
  {
    ...
    a: 'Sim. GRU → Pequim, Pequim → Osaka e Tóquio → GRU. Bagagem: 1× 23kg + 1× 7kg.',
  },
  {
...
export const whatsappUrl = `https://wa.me/message/ZEYCT3PHHMWML1`
