export const expedicao = {
  ...
  duracao: '9 dias',
  duracaoNumero: 9,
  duracaoNumeroLegenda: '8 noites entre Cusco e Lima, com ritmo pensado para a altitude.',
  duracaoExtenso: '9 dias · 8 noites',
  saida: 'Aeroporto de Guarulhos (GRU)',
  saidaCurta: 'Saída de Guarulhos (GRU)',
  cidades: ['Cusco', 'Vale Sagrado', 'Machu Picchu', 'Vinicunca', 'Huacachina', 'Lima'],
  cidadesPrincipaisLinha: 'Cusco · Machu Picchu · Lima',
  bandeira: '🇵🇪',
  ...
  mapaDescricao:
    'Uma travessia que conecta os Andes à costa do Pacífico — de Cusco e do Vale Sagrado a Machu Picchu e à Montanha Colorida, descendo até Paracas, Huacachina e Lima, com deslocamentos e acessos resolvidos.',
  mapaTrajetoTexto: 'Cusco → Vale Sagrado → Machu Picchu → Vinicunca → Paracas → Huacachina → Lima',
  ...
  opcoesDescricao:
    'Uma travessia pelo Peru essencial: Cusco, Vale Sagrado, Machu Picchu, a Montanha Colorida, Paracas, Huacachina e Lima — com acompanhamento constante e experiências conduzidas.',
  ...
  faixaInvestimento: { min: 16000, max: 21000 },
