...
// Esta LP vende a turma de 26/06 a 08/07/2027. A turma anterior (12 a 24/06)
// esgotou: quem chega por link antigo cai em /esgotada.html —
// página estática (public/esgotada.html) que manda pra comunidade do WhatsApp.
// Ela é estática de propósito, pra continuar no ar independente deste App.
// Quando ESTA turma esgotar, troque o return abaixo por <Esgotada /> (o
// componente segue em src/components/Esgotada.tsx, pronto pra uso).
