export const expedicao = {
  ...
  duracaoNumeroLegenda:
    '10 noites entre Istambul, Capadócia, Pamukkale e cruzeiro pelas ilhas gregas — pensão completa a bordo.',
  duracaoExtenso: '13 dias · 10 noites',
...
export const roteiro = [
  ...
  },
  {
    ...
    logistica: 'Guia em português + ingressos inclusos + barco',
  ...
  },
  {
    ...
    atividades: [
      ...
      'Vale de Göreme e museu a céu aberto',
      'Chaminés de Fada de Paşabağ',
      'Cerâmica em Avanos',
    ],
  ...
  },
  {
    ...
    atividades: [
      'Segunda oportunidade de voo de balão (opcional)',
    ...
    veiculos: [
      { emoji: '🎈', label: 'Balão (opcional)' },
      { emoji: '🚐', label: 'Van privativa Capadócia' },
    ],
  },
  {
    dia: 7,
  ...
  },
  {
    ...
    atividades: [
      ...
      'Primeira parada: Patmos — Mosteiro de São João e Gruta do Apocalipse',
    ],
    logistica: 'Transfer + embarque cruzeiro + excursão Patmos',
  ...
  },
  {
    ...
    titulo: 'Éfeso, Casa de Maria & Istambul',
    atividades: [
      'Desembarque em Kusadasi',
      'Ruínas de Éfeso',
      'Casa da Virgem Maria',
      'Traslado para Istambul — última noite na Turquia',
    ],
    logistica: 'Desembarque + Éfeso + traslado para Istambul',
