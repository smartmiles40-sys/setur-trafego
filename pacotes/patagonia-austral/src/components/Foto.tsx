...
/**
 * Renderiza a foto real (de /public/assets/patagonia-austral/) quando ela existe.
 ...
 * certo em public/assets/patagonia-austral/ que a foto aparece sozinha.
 */
export function Foto({
  ...
  return (
    <div className={cn("relative overflow-hidden bg-dark-teal", className)}>
      ...
      <div className="absolute inset-0 patagonia-pattern opacity-50" />
