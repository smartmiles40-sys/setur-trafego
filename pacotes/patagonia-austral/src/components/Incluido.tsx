    ...
    <section id="incluido" className="section-alt relative overflow-hidden grain-subtle">
      <div className="container-x relative">
        ...
        >
          ...
          <div className="patagonia-pattern relative col-span-2 row-span-2 min-h-[240px] overflow-hidden rounded-3xl bg-gradient-to-br from-dark-teal-light via-dark-teal-soft to-dark-teal-light p-6 md:min-h-[320px] md:p-8">
            <div className="absolute inset-0 bg-gradient-to-br from-transparent to-dark-teal/60" />
            <div className="relative flex h-full flex-col justify-between">
              <p className="eyebrow text-lime opacity-90">A experiência</p>
              <div>
